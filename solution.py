...
# Newly added two diagonal unites
diagonal_unites = [[row + col for row, col in zip(rows, cols)],[row + col for row, col in zip(rows, cols[::-1])]]
# Add tow diagonal unities to unitlist
unitlist = row_units + column_units + square_units + diagonal_unites
